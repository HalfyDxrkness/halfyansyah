...
console.log(color(figlet.textSync('Ahmad Khalfy Ramadhani', {
		font: 'Pagga',
...
console.log(color('\n🐶 INSTAGRAM: @khlfyrmdni ','silver'))
console.log(color('🐶 GITHUB: HalfyDxrkness ','silver'))
console.log(color('🐶 WA NUMBER: +642781199999 ','silver'))
console.log(color('  🦄Riakimu-BOT Inc. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/642781199999'))
    console.log(color('🐶', 'cyan'), color('Riakimu Bot Is Online...', 'pink'))
    console.log(color('🐶', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('🐶','red'), color('Thanks For Using Riakimu Bot', 'white'))
